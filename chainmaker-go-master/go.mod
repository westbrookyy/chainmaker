...
require (
	...
	chainmaker.org/chainmaker/consensus-pbft/v2 v2.3.5
	...
	chainmaker.org/chainmaker/net-libp2p v1.2.11
...
replace (
	chainmaker.org/chainmaker/consensus-pbft/v2 => ../consensus-pbft-master
