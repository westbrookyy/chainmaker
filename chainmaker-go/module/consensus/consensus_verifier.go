...
import (
	...
	pbft "chainmaker.org/chainmaker/consensus-pbft/v2"
...
func VerifyBlockSignatures(
	...
	case consensuspb.ConsensusType_PBFT:
		return pbft.VerifyBlockSignatures(chainConf, ac, block, store, pbft.GetValidatorList)
